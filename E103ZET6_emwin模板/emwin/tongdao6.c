...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    EDIT_SetFloatMode(hItem,tongdao.Ssresction[0],-999,999,3,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    ...
    EDIT_SetFloatMode(hItem,tongdao.Ssresction[1],-999,999,3,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    ...
    EDIT_SetFloatMode(hItem,tongdao.Ssresction[2],-999,999,3,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
