  ...
  // USER START (Optionally insert additional message handling)
    ...
    case GUI_KEY_ENTER:
        if((((WM_KEY_INFO*)(pMsg->Data.p))->PressedCnt))
        {
            ...
            {
                case 0:WM_DeleteWindow(pMsg->hWin);Jiaodui1();break;
                case 1:WM_DeleteWindow(pMsg->hWin);Jiaodui2();break;
                case 2:WM_DeleteWindow(pMsg->hWin);Jiaodui3();break;
                case 3:WM_DeleteWindow(pMsg->hWin);Jiaodui4();break;
            }
        }
        WM_DefaultProc(pMsg);
        break;
