...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { LISTBOX_CreateIndirect, "Listbox", ID_LISTBOX_0, 0, 16, 40, 34, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 40, 16, 88, 16, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_1, 40, 32, 88, 16, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Text", ID_TEXT_1, 64, 48, 64, 16, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    LISTBOX_AddString(hItem, "标况");
    LISTBOX_AddString(hItem, "工况");
    LISTBOX_SetFont(hItem, &GUI_FontST16);
    //
    // Initialization of 'Edit'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_0);
    EDIT_SetFloatMode(hItem,buchang.density[0],0,99999,4,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    EDIT_SetFloatValue(hItem,buchang.density[0]);
    EDIT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    EDIT_SetCursorAtChar(hItem,4);
    //
    // Initialization of 'Edit'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_1);
    EDIT_SetFloatMode(hItem,buchang.density[1],0,99999,4,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    EDIT_SetFloatValue(hItem,buchang.density[1]);
    EDIT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    EDIT_SetCursorAtChar(hItem,4);
    //
    // Initialization of 'Text'
  ...
  case WM_TIMER:
      ...
      EDIT_SetFloatValue(hWin_v[2],buchang.density[1]);
      break;
   case WM_KEY:
    ...
    case GUI_KEY_ENTER:
        if((((WM_KEY_INFO*)(pMsg->Data.p))->PressedCnt))
        {
            ...
            {
                buchang.density[0]=EDIT_GetFloatValue(hWin_v[1]);
                LISTBOX_SetSel(hWin_v[0],0);
                WM_SetFocus(hWin_v[0]);
            }
            else if(hItem==hWin_v[2])
            {
                buchang.density[1]=EDIT_GetFloatValue(hWin_v[2]);
                WM_SetFocus(hWin_v[0]);
            }
        }
        WM_DefaultProc(pMsg);
