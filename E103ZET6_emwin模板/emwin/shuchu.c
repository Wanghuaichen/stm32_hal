...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { LISTBOX_CreateIndirect, "Listbox", ID_LISTBOX_0, 20, 15, 80, 50, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    LISTBOX_AddString(hItem, "量程单位");
    LISTBOX_AddString(hItem, "电流输出");
    LISTBOX_AddString(hItem, "脉冲输出");
  ...
  // USER START (Optionally insert additional message handling)
    ...
    case GUI_KEY_ENTER:
        if((((WM_KEY_INFO*)(pMsg->Data.p))->PressedCnt))
        {
            ...
            {
                case 0:WM_DeleteWindow(pMsg->hWin);Shuchu1();break;
                case 1:WM_DeleteWindow(pMsg->hWin);Shuchu2();break;
                case 2:WM_DeleteWindow(pMsg->hWin);Shuchu3();break;
            }
        }
        WM_DefaultProc(pMsg);
        break;
