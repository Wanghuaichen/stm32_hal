...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    EDIT_SetFloatMode(hItem,tongdao.Range[0][0],-999,999,3,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    ...
    EDIT_SetFloatMode(hItem,tongdao.Range[1][0],-999,999,3,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    ...
    EDIT_SetFloatMode(hItem,tongdao.Range[2][0],-999,999,3,GUI_EDIT_SUPPRESS_LEADING_ZEROES);
