...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  uint8_t arr1[][10]={"T,P,△P","PT,P,△P","T,△P","PT,△P","P,△P ","△P "};
  uint8_t i;
  // USER END
  ...
  // USER START (Optionally insert additional message handling)
    ...
    case GUI_KEY_ENTER:
        ...
        {
            tongdao.Type=LISTBOX_GetSel(WM_GetDialogItem(pMsg->hWin, ID_LISTBOX_0));
