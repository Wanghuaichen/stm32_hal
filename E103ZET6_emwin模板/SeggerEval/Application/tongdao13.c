...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    EDIT_SetFloatMode(hItem,tongdao.Range[0][2],-999999,999999,3,GUI_EDIT_SIGNED|GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    ...
    EDIT_SetFloatMode(hItem,tongdao.Range[1][2],-999999,999999,3,GUI_EDIT_SIGNED|GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    EDIT_SetFloatValue(hItem,tongdao.Range[1][2]);
    EDIT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    //
    // Initialization of 'Edit'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_2);
    EDIT_SetFloatMode(hItem,tongdao.Range[2][2],-999999,999999,3,GUI_EDIT_SIGNED|GUI_EDIT_SUPPRESS_LEADING_ZEROES);
    EDIT_SetFloatValue(hItem,tongdao.Range[2][2]);
    EDIT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
  ...
  // USER START (Optionally insert additional message handling)
    ...
    case GUI_KEY_ENTER:
        if((((WM_KEY_INFO*)(pMsg->Data.p))->PressedCnt))
        {
            ...
            {
                tongdao.Range[0][2]=EDIT_GetFloatValue(hWin_v[1]);
                WM_SetFocus(hWin_v[0]);
            }
            else if(hItem==hWin_v[2])
            {
                tongdao.Range[1][2]=EDIT_GetFloatValue(hWin_v[2]);
                WM_SetFocus(hWin_v[0]);
            }
            else if(hItem==hWin_v[3])
            {
                tongdao.Range[2][2]=EDIT_GetFloatValue(hWin_v[3]);
                WM_SetFocus(hWin_v[0]);
            }
        }
        WM_DefaultProc(pMsg);
